...
public class SurveyFullInsertTest {
//	private Survey survey;
	...
	@Test
	/**
	 * Execute a survey insert and a surveyTag insert linked to the currently inserted survey and a pre-existent SurveyCatalog
	 */
...
//		survey = SurveyDBManager.update(survey);
		SurveyTagDBManager.insert(st);
//		SurveyTagDBManager.insert(st);
		List<Survey> surveys = SurveyDBManager.selectAll();
