    ...
    $http({
      ...
      if (questions!=undefined) {
      	...
      	for(var i=0; i < questions.length; i++) {
          	$scope.show[i] = false;
          	if (i === 0) {
          		console.log("LUCA MUORI");
          		console.log("i");
          		console.log($scope.previousVisible);
      ...
      function visible () {
    	  console.log("ENTRO NELLA MIA FUNZIONE");
    	  for (var i=0; i<questions.length; i++) {
//    		  if (i === 0) {
//    			  console.log("ALLA PRIMA DOMANDA SETTO PREVIOUS INVISIBLE");
//    			  console.log("i");
//    			  $scope.previousVisible = false;
////    			  $scope.nextVisible = true;
    		   if (i != 0){
    			  console.log("DALLA SECONDA IN POI LO SETTO VISIBILE");
    			  console.log(i);
    			  $scope.previousVisible = true;
    			  console.log($scope.previousVisible);
//    			  $scope.nextVisible = false;
